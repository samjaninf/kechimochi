...
function createServices(): TestServices {
    return {
        ...
        getDatabaseRecoveryPlan: vi.fn(),
        applyDatabaseRecovery: vi.fn(),
        shouldSkipLegacyLocalProfileMigration: vi.fn(),
